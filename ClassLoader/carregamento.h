...
/**
*   @fn void carrega_constantpool(FILE *arquivo, ClassFile *classe)
...
/**
*   @fn void carrega_flagseclasses(FILE *arquivo, ClassFile *classe)
...
/**
*   @fn void carrega_interfaces(FILE *arquivo, ClassFile *classe)
...
/**
*   @fn void carrega_fields(FILE *arquivo, ClassFile *classe)
...
/**
*   @fn void carrega_methods(FILE *arquivo, ClassFile *classe)
...
/**
*   @fn void carrega_attributes(FILE *arquivo, ClassFile *classe)
...
/**
*   @fn void carrega_attribute(FILE *arquivo, ClassFile *classe, attribute_info *atributo)
